...
def main(args):
    data_train_valid, data_test, (len_train, len_valid), train_lookup, valid_lookup, test_lookup, test_lookup_sub, train_valid_lookup_sub = load_datasets(args)
    ...
    all_users = {**train_valid_lookup_sub, **offset_test_lookup}
