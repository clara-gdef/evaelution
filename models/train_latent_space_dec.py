...
if __name__ == "__main__":
    ...
    parser.add_argument("--vae_load_mode", type=str, default="latest") # can be "spe" or "latest"
    parser.add_argument("--vae_title", type=str, default="vae_no_dec_bs128_mlphs256_lr0.001_adam") # can be "spe" or "latest"
